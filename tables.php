...
function IWmessages_tables()
{
	...
	$pntable['IWmessages'] = DBUtil::getLimitedTablename('IWmessages');
	$pntable['IWmessages_column'] = array('msg_id' => 'iw_msg_id',
	...
	$pntable['IWmessages_column_def'] = array('msg_id' => "INT(10) NOTNULL AUTOINCREMENT KEY",
	...
	ObjectUtil::addStandardFieldsToTableDefinition ($pntable['IWmessages_column'], 'pn_');
	ObjectUtil::addStandardFieldsToTableDataDefinition($pntable['IWmessages_column_def'], 'iw_');

	// IWmain table definition needed in this module
	$pntable['IWmain'] = DBUtil::getLimitedTablename('IWmain');
	$pntable['IWmain_column'] = array('id' => 'iw_id',
						'uid' => 'iw_uid',
						'module' => 'iw_module',
						'name' => 'iw_name',
						'value' => 'iw_value',
