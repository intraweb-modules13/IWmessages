...
function IWmessages_user_main()
{
	...
	return $view -> fetch('IWmessages_user_main.htm');
}
 ...
 */
function IWmessages_user_view($args){
...
*/
function IWmessages_user_module()
{
	...
	return $view -> fetch('IWmessages_user_module.htm');
}
 ...
 */
function IWmessages_user_display($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	...
	if (!is_array($item)) {
    	$view -> assign('errormsg', __('You don\'t have any messages', $dom));
	} else {
    	$message = array();
    	$item['posterdata'] = UserUtil::getVars($item['from_userid']);
 ...
 * @return       output       The item detail page
 */
function IWmessages_user_displaysend($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
...
*/
function IWmessages_user_getFile($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
 ...
 * @return       output       The item detail page
 */
function IWmessages_user_delete($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
 ...
 * @return       output       The item detail page
 */
function IWmessages_user_compose($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	...
	if(!empty($reply)){
		...
		if (!empty($uname)) {$view->assign('touser', $uname);}
 ...
 * @return       output       The item detail page
 */
function IWmessages_user_submit($args){
	$dom = ZLanguage::getModuleDomain('IWmessages');
	$image = FormUtil::getPassedValue('image', isset($args['image']) ? $args['image'] : null, 'POST');
	...
	if (!SecurityUtil::confirmAuthKey('IWmessages')) {
		return LogUtil::registerAuthidError (ModUtil::url('IWmessages', 'user', 'main'));
	}
	...
	if (UserUtil::isLoggedIn()) {$message .= "[addsig]";}
	...
	if (count($usersId) == 0) {
		...
		foreach($usersId as $userId){
			if (ModUtil::apiFunc('IWmessages', 'user', 'create',
				...
				$view = Zikula_View::getInstance('IWmessages',false);
				$view -> clear_cache(null, $to_userid);
				$sended++;
			} else {
				$error++;
			}
 ...
 * @return       output       The item detail page
 */
function IWmessages_user_check($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	if (!SecurityUtil::checkPermission( 'IWmessages::', '::', ACCESS_OVERVIEW) || !UserUtil::isLoggedIn()) {
		return LogUtil::registerPermissionError();
 ...
 */
function IWmessages_user_download($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	// Get the parameters
...
function IWmessages_user_pager($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	$rpp = FormUtil::getPassedValue('rpp', isset($args['rpp']) ? $args['rpp'] : null, 'POST');
