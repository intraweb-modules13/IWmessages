...
*/
function IWmessages_ajax_marca($args)
{
 ...
 * @return:	Redirect to the user main page
*/
function IWmessages_ajax_mark($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	if (!SecurityUtil::checkPermission('IWmessages::', '::', ACCESS_READ)) {
		AjaxUtil::error(DataUtil::formatForDisplayHTML(__('Sorry! No authorization to access this module.', $dom)));
...
*/
function IWmessages_ajax_delete($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	if (!SecurityUtil::checkPermission('IWmessages::', '::', ACCESS_READ)) {
		AjaxUtil::error(DataUtil::formatForDisplayHTML(__('Sorry! No authorization to access this module.', $dom)));
...
*/
function IWmessages_ajax_autocompleteUser($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	if (!SecurityUtil::checkPermission('IWmessages::', '::', ACCESS_READ)) {
		AjaxUtil::error(DataUtil::formatForDisplayHTML(__('Sorry! No authorization to access this module.', $dom)));
...
function IWmessages_ajax_view($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	if (!SecurityUtil::checkPermission('IWmessages::', '::', ACCESS_READ)) {
		AjaxUtil::error(DataUtil::formatForDisplayHTML(__('Sorry! No authorization to access this module.', $dom)));
...
function IWmessages_ajax_display($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	if (!SecurityUtil::checkPermission('IWmessages::', '::', ACCESS_READ)) {
		AjaxUtil::error(DataUtil::formatForDisplayHTML(__('Sorry! No authorization to access this module.', $dom)));
...
function IWmessages_ajax_displaysend($args)
{
	$dom = ZLanguage::getModuleDomain('IWmessages');
	if (!SecurityUtil::checkPermission('IWmessages::', '::', ACCESS_READ)) {
		AjaxUtil::error(DataUtil::formatForDisplayHTML(__('Sorry! No authorization to access this module.', $dom)));
